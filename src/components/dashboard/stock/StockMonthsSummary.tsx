// src/components/dashboard/inventory/StockMonthsSummary.tsx
import React, { useState } from 'react';
import { FiClock } from 'react-icons/fi';
import { StockSummaryCard } from './StockSummaryCard';
import { StockProductsModal } from './StockProductsModal';
import { useStockMonths, StockProductData } from '@/hooks/useStockMonths';

export function StockMonthsSummary() {
  // Récupérer les données des mois de stock
  const { 
    criticalLow, 
    toWatch, 
    optimal, 
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-base font-medium text-gray-700 dark:text-gray-300">
          Synthèse des stocks (en mois de vente)
        </h2>
      </div>
